    ...
    <div className="user-profile">
      <div className="user-profile-block">
        ...
        <div className="user-profile-details">
          <h2 className="user-profile-name">{profile.fullname.first_name} {profile.fullname.last_name}</h2>
          <span>Email</span>
          <br />
          <h5>{profile.email}</h5>
          <span>Address</span>
          <br />
          {profile.address ? (
            <h5>{profile.address.noHouse}, {profile.address.street}, {profile.address.district}, {profile.address.Downtown}, {profile.address.city}, {profile.address.country}</h5>
          ) : (
