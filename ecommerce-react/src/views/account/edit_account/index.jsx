  ...
  fullname: Yup.object()
    .shape({
      first_name: Yup.string()
        ...
        .max(20, 'First name should be only be 4 characters long.')
        .required('First name is required'),
      last_name: Yup.string()
        .min(4, 'Last name should be at least 4 characters.')
        .max(20, 'Last name should be only be 4 characters long.')
...
const EditProfile = () => {
  useDocumentTitle('Edit Account | EShop');
  useScrollTop();
