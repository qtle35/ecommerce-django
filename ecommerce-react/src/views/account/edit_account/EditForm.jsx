...
const EditForm = ({ isLoading, authProvider }) => {
  ...
  return (
    <div className="user-profile-details">
      ...
      <Field
        disabled={isLoading}
        name="address.noHouse"
        type="text"
        label="Number of House (Will be used for checkout)"
      ...
      <Field
        ...
        name="address.street"
        type="text"
        label="Street (Will be used for checkout)"
        // placeholder="#245 Brgy. Maligalig, Arayat Pampanga, Philippines"
        component={CustomInput}
        style={{ textTransform: 'capitalize' }}
      />
      <Field
        ...
        type="text"
        label="District (Will be used for checkout)"
        // placeholder="#245 Brgy. Maligalig, Arayat Pampanga, Philippines"
        component={CustomInput}
        style={{ textTransform: 'capitalize' }}
      />
      <Field
        ...
        name="address.city"
        type="text"
        label="City (Will be used for checkout)"
        // placeholder="#245 Brgy. Maligalig, Arayat Pampanga, Philippines"
        component={CustomInput}
        style={{ textTransform: 'capitalize' }}
      />
      <Field
        ...
        type="text"
        label="Country (Will be used for checkout)"
        // placeholder="#245 Brgy. Maligalig, Arayat Pampanga, Philippines"
        component={CustomInput}
        style={{ textTransform: 'capitalize' }}
      />
