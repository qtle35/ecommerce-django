...
const ViewProduct = () => {
  ...
  const { product, isLoading, error } = useProduct(typeProduct, id);
  ...
  const handleAddToBasket = () => {
    addToBasket({ ...product, maxQuantity: product.quantity, quantity: 1 });
  };
          ...
          <div className="product-modal">
            ...
            <div className="product-modal-details">
              ...
              <span className="text-subtle">
                {
                  product.type_product === 'book' ?
                    product.author.name :
                    product.type_product === 'mobile' ?
                      product.type.name :
                      null
                }
              </span>
